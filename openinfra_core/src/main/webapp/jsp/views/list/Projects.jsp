	...
	<div class="col-md-4">
		<div id="githubDiv" class="panel panel-default">
			<div class="panel-heading">
				<a href="https://github.com/OpenInfRA/core/commits/master">OpenInfRA-Github Commits</a>
			</div>
			<table id="github" class="table table-hover">
			</table>
		</div>
	</div>
</div>
...
<script>
	$(document).ready(function() {
		// build a 
		var url = "https://api.github.com/repos/OpenInfRA/core/commits";
		$.ajax({
			url: url,
	        dataType: "json",
			type: "GET",
			...
			var content = "<tbody>";
			// cicle through the commits
			for (i in data) {
				content += "<tr>";
				content += "<td>";
				content += data[i].commit.author.date;
				content += "</td>";
				content += "<td>";
