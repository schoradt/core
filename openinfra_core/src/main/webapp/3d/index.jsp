	...
	<div id="content">
		<div id="navigation">
			...
			<form id="navbuttons">
				...
				<input type="button" value="Konsole öffnen" onclick="toggleDebug();" title="Shortcut: d"></input><br>
				<input type="button" value="Statistik anzeigen" onclick="toggleStats();" title="Shortcut: Leertaste"></input><br>
				<input type="button" value="Rendermodus ändern" onclick="$element.runtime.togglePoints();return false;" title="Shortcut: m"></input><br>
			</form>
			<hr></hr>
			<ul>
				...
				<li>d: Konsole öffnen</li>
				<li>r: Kamera zuruecksetzen</li>
				<li>m: Rendermodus ändern</li>
				<li>Doppelklick LM: Ursprung ändern</li>
			</ul>
		</div>
		...
		<div id ="center">
			...
			<X3D xmlns="http://www.web3d.org/specifications/x3d-namespace" width="800px" height="600px" id="x3d" onmousemove="saveMouseCoords();">
				...
				<!-- <Param name="showProgress" value="false" ></Param>		Theoretisch möglich, hat aber nie funktioniert!-->
				<Scene id="s">
		...
		<div id="interaktion">
			<p class="ueberschrift">Interaktionsmöglichkeiten</p>
			<!-- Container für Modellauswahl -->
			<div id="modelle" style="max-height:700px;overflow: auto;"></div>
			<br></br>
			<div>
				<p>Modell auswählen, dessen Farbe geändert werden soll:</p>
				<form>
					<!-- Platzhalter für Pulldown -->
					<select id="modellAuswahl"></select>
				</form>
				<!-- Farbauswahl über JsColor -->
