...
function init() {
	...
	xmlhttp.open("GET",window.contextPath + "/rest/v1/projects?language=de-DE",true);
...
function changeProject(name){
	...
	xmlhttp.open("GET",window.contextPath + "/rest/v1/projects/"+uuid+"/topiccharacteristics?language=de-DE",true);
	xmlhttp.setRequestHeader("Accept","application/xml");
	xmlhttp.send(null);
...
function onclickTT(element) {
	...
	var url = window.contextPath + "/rest/v1/projects/"+p_uuid+"/topicinstances/"+ti_uuid+"/topic?language=de-DE";
	window.open(url);
}
...
function getScene(value,project){
	...
	xmlhttp.open("GET",window.contextPath + "/rest/v1/projects/"+p_uuid+"/topiccharacteristics/"+topic_uuid+"/topicinstances/geomz?language=de-DE&geomType=X3D",true);
	xmlhttp.setRequestHeader("Accept","application/xml");
	xmlhttp.send(null);
}
