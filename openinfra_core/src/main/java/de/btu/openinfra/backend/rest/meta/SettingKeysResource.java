...
public class SettingKeysResource {
    ...
    public List<SettingKeysPojo> get(
        ...
        return new SettingKeysDao(OpenInfraSchemas.META_DATA).read(
                null,
                offset,
                size);
    }
    ...
    @GET
    @Path("{settingKeysId}")
    public SettingKeysPojo get(@PathParam("settingKeysId") UUID settingKeysId) {
        return new SettingKeysDao(OpenInfraSchemas.META_DATA).read(
                        null,
                        settingKeysId);
    }
    ...
    public Response delete(@PathParam("settingKeysId") UUID settingKeysId) {
        boolean deleteResult =
                new SettingKeysDao(OpenInfraSchemas.META_DATA).delete(
                        settingKeysId);
